  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col">
        <span className="text-2xl leading-none text-[#222]" style={{ fontFamily: 'Georgia, serif', letterSpacing: '0.05em' }}>
          finbook
        </span>
        <span className="text-xl leading-none text-[#888]" style={{ fontFamily: 'Georgia, serif', letterSpacing: '0.08em', marginLeft: '1.25rem' }}>
